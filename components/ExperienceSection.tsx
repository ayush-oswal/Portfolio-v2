      ...
      <div className="flex flex-col gap-20">
        ...
        >
          <div className="flex flex-row gap-4 items-start">
            ...
            >
              <div className="bg-white/90 rounded-lg p-2 mb-4 border border-border">
                <Image
              ...
              <LinkPreview url="https://azodha.com">
                <div className="flex items-center gap-2 bg-[#111] hover:bg-elevated border border-border hover:border-brand/50 rounded-lg px-3 py-2 cursor-pointer mb-4 transition-all duration-200">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-1">Product Engineer (Backend) · Sep 2025 – Present</h3>
              <p className="text-lg text-muted-foreground mb-1">Azodha, Pune, India (Hybrid)</p>
              <p className="text-sm italic mb-4">
                <span className="text-brand">(They kept me. Interpret that how you will.)</span>
              </p>
            </div>
          </div>
          <motion.ul
        ...
        >
          <div className="flex flex-row gap-4 items-start">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-1">SDE Intern (Backend) · Dec 2024 – Aug 2025</h3>
              <p className="text-lg text-muted-foreground mb-1">Azodha, Pune, India (Hybrid)</p>
              <p className="text-sm italic mb-4">
                <span className="text-brand">(Where the imposter syndrome began, and later, suspiciously, faded.)</span>
              </p>
            </div>
          </div>
          <motion.ul
        ...
        >
          <div className="flex flex-row gap-4 items-start">
            ...
            >
              ...
              <div className="flex gap-2">
                <LinkPreview url="https://yourbot.ayushoswal.com">
                  <div className="flex items-center gap-2 bg-[#111] hover:bg-elevated border border-border hover:border-brand/50 rounded-lg px-3 py-2 cursor-pointer transition-all duration-200">
                    <Globe className="h-5 w-5 text-white" />
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-1">Founder — YourBot</h3>
              <p className="text-sm italic mb-1">
                <span className="text-brand">(Self-appointed, naturally. The equity situation is very favorable.)</span>
              </p>
